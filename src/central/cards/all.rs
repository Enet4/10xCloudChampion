...
pub static ALL_CARDS: &'static [CardSpec] = &[
    ...
    CardSpec {
        ...
        effect: CardEffect::AddPublicity(22.0),
    },
    CardSpec {
        id: "d2",
        title: "Fliers",
        ...
        effect: CardEffect::AddPublicity(38.0),
    },
    CardSpec {
        id: "d3",
        ...
        effect: CardEffect::AddPublicity(80.0),
    },
    CardSpec {
        id: "d3.5",
        ...
        effect: CardEffect::AddPublicity(180.),
    },
    CardSpec {
        id: "d4",
        ...
        effect: CardEffect::AddPublicity(550.0),
    },
    CardSpec {
        id: "d4.5",
        title: "Blame caching",
        ...
        effect: CardEffect::AddPublicity(60.),
    },
    CardSpec {
        id: "d5",
        ...
        effect: CardEffect::AddPublicity(999.0),
    },
    CardSpec {
        id: "d6",
        ...
        effect: CardEffect::AddPublicity(10_000.0),
    },
    CardSpec {
        id: "d7",
        title: "Hypodrones",
        ...
        effect: CardEffect::AddPublicity(200_000.0),
    },
    // --- energy cards ---
    CardSpec {
        id: "e0",
    ...
    CardSpec {
        ...
        cost: Cost::dollars(460).and(Cost::super_ops(300)),
